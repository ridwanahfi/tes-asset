<body>
	...
	$filterSQL GROUP BY services.no_service ORDER BY services.no_service DESC";
	...
	<div class="table-border">
		<div style="overflow-x:auto;">
			<h2>DAFTAR SERVIS <a href="?open=Service-Baru" target="_self"><img style='padding-right:0px !important' src="images/btn_add_data.png" border="0" /></a></h2>
			...
			<table id="example1" class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
				...
				<tbody>
					...
					barang_inventaris.*, service_item.kerusakan
					FROM services 
						...
						<tr bgcolor="<?php echo $warna; ?>">
							...
							<td>
								<?php if ($myData['status'] == 'DONE' || $myData['status'] == 'CANCEL') : ?>
									...
									<a href="service_cetak.php?Kode=<?php echo $Kode; ?>" target="_blank">
