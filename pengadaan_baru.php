<body>
	...
	if (isset($_POST['btnSimpan'])) {
		...
		if ($pesanError) {
			...
			$mySql	= "INSERT INTO pengadaan (no_pengadaan, tgl_pengadaan, keterangan, jenis_pengadaan, kd_petugas, foto, foto_form, nomor_resi, kd_departemen, kd_lokasi, status) VALUES ('$kodeBaru', '$txtTanggal', '$txtKeterangan', '$cmbJenis', '$userLogin', '$fileName', '$fileForm', '$txtNomorResi', '$cmbDepartemen', '$cmbLokasi', 'Purchase Request')";
